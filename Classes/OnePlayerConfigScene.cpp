...
Scene* OnePlayerConfigScene::createScene() {
    auto scene = Scene::create();
    auto layer = OnePlayerConfigScene::create();
...
bool OnePlayerConfigScene::init() {
    ...
    auto subtitle = Sprite::create("image/1 Player Mode/subtitle1.png");
    ...
    auto swapBg = Sprite::create("image/1 Player Mode/color_border.png");
    swapBg->setName("colorSwitchBg");
    FigmaLayoutHelper::apply(swapBg, 470, 670, 613, 109);
    swapBg->setScale(0.7f);
    this->addChild(swapBg);

    auto orange = Button::create("image/1 Player Mode/cam.png");
    ...
    auto green = Button::create("image/1 Player Mode/xanh.png");
    ...
    auto swapBtn = Button::create("image/1 Player Mode/arrow.png");
    ...
    auto btnP1 = Button::create("image/1 Player Mode/border.png");
    ...
    auto btnP2 = Button::create("image/1 Player Mode/border.png");
    ...
    //--- DIFFICULTY ---
    this->addChild(UIManager::createLabelFigma("DIFFICULTY", 26, 55, 350, 267, 66));
    ...
    updateDifficultyByPercent(slider->getPercent());

    // Gắn sự kiện
    slider->addEventListener([=](Ref*, Slider::EventType type) {
        updateDifficultyByPercent(slider->getPercent());
    });

    // --- BACK BUTTON ---
    auto back = UIManager::getInstance()->createButton("image/1 Player Mode/back button.png",
    ...
    // --- START BUTTON ---
    auto start = UIManager::getInstance()->createButton("image/1 Player Mode/start button.png",
        Vec2(center.x + 150, 270),
        [=](Ref*) {
...
void OnePlayerConfigScene::updateColorUI() {
    ...
    if (_colorP1 == 1) {
        sprite1->loadTextureNormal("image/1 Player Mode/camSelect.png");
        sprite2->loadTextureNormal("image/1 Player Mode/xanh.png");
        _player1Avatar->setTexture("image/1 Player Mode/cam.png");
        _player2Avatar->setTexture("image/1 Player Mode/xanh.png");
    }
    else {
        sprite1->loadTextureNormal("image/1 Player Mode/xanhSelect.png");
        sprite2->loadTextureNormal("image/1 Player Mode/cam.png");
        _player1Avatar->setTexture("image/1 Player Mode/xanh.png");
        _player2Avatar->setTexture("image/1 Player Mode/cam.png");
    }
}

void OnePlayerConfigScene::updateFirstMoveUI() {
    ...
    if (_firstMove == 1) {
        sprite1->setTexture("image/1 Player Mode/camSelect.png");
        sprite2->setTexture("image/1 Player Mode/xanh.png");
    }
    else {
        sprite1->setTexture("image/1 Player Mode/cam.png");
        sprite2->setTexture("image/1 Player Mode/xanhSelect.png");
    }
}

void OnePlayerConfigScene::updateDifficultyByPercent(int percent) {
    if (percent < 33) _difficulty = 1;
    else if (percent < 66) _difficulty = 2;
    else _difficulty = 3;
}
